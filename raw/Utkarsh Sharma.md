...
source: "https://utkarshsharma2002us.github.io/#projects"
author:
published:
created: 2026-08-26
description:
...
I'm an MCA Graduate from Ajay Kumar Garg Engineering College with a strong foundation in computer applications and a deep passion for building intelligent systems. My work sits at the intersection of AI/ML, data science, and software development.

From building RAG-powered document assistants to automating PDF processing pipelines, I love turning complex problems into elegant, working solutions. Currently interning at Foremark Technology, contributing to real-world Business automation systems.
...
Node.js PostgreSQL Model Context Protocol (MCP) Render Claude Integration Markdown

Built a Markdown-based personal wiki with pages, tags, and a bidirectional knowledge graph following the Karpathy pattern: raw sources → structured wiki → knowledge graph → query flow. Indexed the wiki into PostgreSQL and built a Node.js MCP server exposing search, page lookup, and link-graph tools, deployed publicly on Render and connected to Claude as a live custom connector.
...
- Educational internship with Edufyi Tech Solutions knowledge in the field of Artificial Intelligence, Gain practical experience.
